...
if client is None:
    ...
    st.error(
        ...
        "El administrador debe configurar GROQ_API_KEY en los Secrets de Streamlit."
    )
...
with col2:
    ...
    <div class="glass">
        ...
        <h3>Programación</h3>
        <div class="small">
            Aprende Python, web, APIs y mucho más.
        </div>
    </div>
    """, unsafe_allow_html=True)
...
with st.sidebar:
    ...
    st.caption("Santi AI")
    st.caption("Desarrollado con Python + Streamlit + Groq")
...
if len(st.session_state.messages) == 0:
    ...
    <div class="glass">
        ...
        <p class="small">
            Puedes preguntarme sobre programación, videojuegos,
            tecnología, tareas, matemáticas, ideas para proyectos
...
- explica los errores
- evita complicar innecesariamente las soluciones
