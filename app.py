...
div[data-testid="stImage"] img {
    ...
    border:
        1px solid
        rgba(140, 80, 255, 0.3) !important;

    box-shadow:
        0 0 25px
        rgba(120, 80, 255, 0.3) !important;
...
# =========================================================
# FUNCIÓN PARA COLOCAR LA RESPUESTA ARRIBA
# =========================================================
...
<div class="welcome">
    ...
    <p>
        ...
        aprendizaje o cualquier otra cosa.
...
with st.sidebar:
    ...
    if todos_los_chats:
        ...
        for chat_id, chat_data in reversed(
            list(todos_los_chats.items())
        ):

            titulo = chat_data.get(
                "titulo",
                "Chat sin título"
            )
